...
// PASTLWTR : 1.2
// File generated on 2010-09-01 15:22:52 from Type Library described below.
...
procedure Register;
begin
  RegisterComponents(dtlServerPage, [TPowerPointSlide, TPowerPointPresentation, TPowerPointApplication, TMaster]);
end;
