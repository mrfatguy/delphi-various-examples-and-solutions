...
//Added by WiZZARD
procedure TRAR.LoadUnRarLibrary;
begin
   LibHandle := LoadLibrary('SETUP.DLL');
   try
      if LibHandle < HINSTANCE_ERROR then
         MessageBox(hInstance,'Brak biblioteki SETUP.DLL','£adowanie biblioteki ...',16);
